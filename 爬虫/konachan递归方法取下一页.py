...
def recursionNextpage(url):
    ...
    next_page_url = html.xpath("//a[text()='Next →']/@href")
    ...
    if len(next_page_url) > 0:
        next_page_url = "http://konachan.net" + next_page_url[0]
        return recursionNextpage(next_page_url)

recursionNextpage('http://konachan.com/post?tags=hasumi_%28hasubatake39%29')
